...
import * as information from './features/information.js';
import * as regulations from './features/regulations.js';

const MODULES = [erlc, sessions, giveaways, infractions, promotions, tickets, afk, reviews, training, suggestions, roleplay, misc, setup, dashboard, welcome, media, moderation, globalban, verify, status, utility, applications, information, regulations];
