...
export function registerLowGpuHandlers(): void {
  ...
  ipcMain.handle('lowgpu:apply',   () => { const s = getSettings(); return applyPerformance({ lowGpu: s.lowGpuEnabled, fpsCap: s.fpsCap ?? 0, disableTextures: s.disableTextures, minimalLighting: s.minimalLighting, skipSplash: s.skipSplash }) })
